...
**Source image (text transcribed below; original screenshot linked, per v2 policy):**

**Original image:** [`image5.png`](../source/images/image5.png) — *"Core stance on the conflict — comparison table of the Mainstream Sunni Perspective vs the Traditional Shia Perspective on the "narrative lens", core stance, and view of the companions involved in the first fitnah/Battle of the Camel."*  
...
**Source images — Shia and Sunni tafsir of Surah al-Bayyinah 98:7–8 and
Surah at-Tawbah 9:100 (text transcribed below; original screenshots
linked, per v2 policy):**

**Original image:** [`image7.png`](../source/images/image7.png) — *"The Shia Perspective (Tafseer Ahl al-Bayt) on "Khayr al-Bariyyah" and the Loyal Companions."*  
(full text already transcribed below — v2 links to the image for reference rather than re-embedding it, per the v2 editing permissions)
...
**Original image:** [`image6.png`](../source/images/image6.png) — *"Shia view on context (Surah At-Tawbah 9:100) vs. the Sunni Perspective on the same verse."*  
(full text already transcribed below — v2 links to the image for reference rather than re-embedding it, per the v2 editing permissions)
...
**Source images — Marwan ibn al-Hakam's companionship status and later
record (text transcribed below; original screenshots linked, per v2
policy):**

**Original image:** [`image9.png`](../source/images/image9.png) — *"Companionship Status (Sahabah) of Marwan, and the Exile Controversy of his father Al-Hakam ibn Abi al-As."*  
(full text already transcribed below — v2 links to the image for reference rather than re-embedding it, per the v2 editing permissions)
...
**Original image:** [`image8.png`](../source/images/image8.png) — *"Sunni history books do not shy away from documenting Marwan's later transgressions — hostility to Ahl al-Bayt, advice to Yazid, and the Sunni verdict on him as narrator vs. as leader."*  
(full text already transcribed below — v2 links to the image for reference rather than re-embedding it, per the v2 editing permissions)
